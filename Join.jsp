		...
		<!-- 질문 -->
			<tr>
				...
				<td colspan="3"><select class="select" id="ask">
						...
						<option id="ask" value="q1">제일 좋아하는 장소는?</option>
						<option id="ask" value="q2">소중하게 여기는 보물은?</option>
						<option id="ask" value="q3">제일 좋아하는 인물은?</option>
						<option id="ask" value="q4">제일 좋아하는 음식은?</option>
				</select></td>
			<tr>
				<td align="center">
					<p class="main">
